...
const required = [
  ...
  "public/skills/claudeemailskill/SKILL.md",
  "public/.well-known/skills/claudeemailskill/SKILL.md",
  "public/.well-known/agent-skills/claudeemailskill/SKILL.md",
...
if (!markdown.includes("npx skills add claudeemailskill")) throw new Error("Missing markdown install shortcut");
...
if (indexJson.skills?.[0]?.name !== "claudeemailskill") throw new Error("Invalid well-known skills index");
